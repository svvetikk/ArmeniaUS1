...
public class tatevInfo extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tatev_info);
        setContentView(R.layout.activity_sanahin_info);
        setContentView(R.layout.activity_garni_info);
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.tatev);
